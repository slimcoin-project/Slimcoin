  ...
  model(0)
{
  ...
  ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Slimcoin address"));
#endif
...
void SendCoinsDialog::setModel(WalletModel *model)
{
  ...
  if(model)
  {
    ...
    connect(model, SIGNAL(balanceChanged(qint64, qint64, qint64, qint64, qint64, BurnCoinsBalances, qint64, qint64, qint64)), this, SLOT(setBalance(qint64, qint64, qint64, qint64, qint64, qint64, qint64)));
...
void SendCoinsDialog::on_sendButton_clicked()
{
  ...
  if (!model->getOptionsModel() || !model->getOptionsModel()->getCoinControlFeatures())
      sendstatus = model->sendCoins(recipients, NULL, txtmsg, false);
  else
      sendstatus = model->sendCoins(recipients, CoinControlDialog::coinControl, txtmsg, false);
