...
BOOST_AUTO_TEST_CASE(basic_transaction_tests)
{
  ...
  /* FIXME: need to wrap this in a try/catch to handle:
  unknown location(0): fatal error in "basic_transaction_tests":
    std::runtime_error: CDataStream::read() : end of data: iostream error
  */
